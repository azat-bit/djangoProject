...
from myapp.views import blog_list,blog_create_ajax, blog_detail, comment_list, category_list, category_detail, tag_list, tag_detail, user_profile
from django.contrib.auth.views import LoginView, LogoutView
from myapp.views.auth_views import user_login, register

urlpatterns = [
    path('admin/', admin.site.urls),
    path('', blog_list, name='blog_list'),
    path('blog/create/ajax/', blog_create_ajax, name='blog_create_ajax'),
